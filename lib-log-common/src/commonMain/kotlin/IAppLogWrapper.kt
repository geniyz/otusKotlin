...
interface IAppLogWrapper {
    ...
    /**
     * Функция обёртка для выполнения прикладного кода с логированием перед выполнением и после
     */
    ...
    /**
     * Функция обёртка для выполнения прикладного кода с логированием ошибки
     */
    ...
    companion object {
        val DEFAULT = object: IAppLogWrapper {
