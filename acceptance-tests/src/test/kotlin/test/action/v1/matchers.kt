...
val IResponse.obj: ObjResponseObject?
    get() = when (this) {
        is ObjCreateResponse -> obj
        is ObjReadResponse -> obj
        is ObjUpdateResponse -> obj
        is ObjDeleteResponse -> obj
        is ObjListTagsResponse -> obj
